    ...
    protected void onPostExecute(String fromDoInBackground) {
        if(lyrics!=null) {
            ...
            if( isTablet) {
                ...
                //isPhone
                Intent nextActivity = new Intent(CitiesMainActivity.this, LyricsEmptyActivity.class);
            ...
            Toast.makeText(CitiesMainActivity.this, message, Toast.LENGTH_SHORT).show();
        }
